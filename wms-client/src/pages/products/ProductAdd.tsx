                                ...
                                <div className="row g-3">
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <input type="text" className="form-control" id="name"
                                               placeholder="Schreiben Sie den Produktnamen"
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <input type="text" className="form-control" id="description"
                                               placeholder="Schreiben Sie die Beschreibung"
                                    ...
                                    <div className="col-sm-4">
                                        ...
                                        <input type="number" className="form-control" id="salePrice"
                                               placeholder="Schreiben Sie den Verkaufspreis"
                                               onChange={(e) => setProduct({...product, salePrice: e.target.valueAsNumber})}/>
                                    </div>
                                    ...
                                    <div className="col-sm-4">
                                        ...
                                        <input type="number" className="form-control" id="criticalStock"
                                               placeholder="Schreiben Sie den kritischen Lagerbestand"
                                               onChange={(e) => setProduct({...product, criticalStock: e.target.valueAsNumber})}/>
                                    </div>

                                    <div className="col-sm-4">
                                        <label htmlFor="categoryName" className="form-label">Kategoriename</label>
                                        <select className="form-select" id="categoryName" onChange={(e) => setProduct({...product, categoryId: e.target.value})}>
                                    ...
                                    <div className="col-sm-12">
                                        ...
                                        <input type="number" className="form-control" id="imageUrl"
                                               placeholder="Schreiben Sie die Bild URL"
